...
const FinSightLanding = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: " AI Assistant",
      description: "Integrated with Google Wallet for seamless commands"
    }
  ];
    ...
    <div className="bg-slate-950 text-white overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 py-20">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            <button className="group px-8 py-4 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-violet-500/50 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2">
              Try Demo
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {/* Top left corner */}
          <div className="absolute animate-float" style={{ left: '5%', top: '10%', animationDelay: '0.2s', animationDuration: '3s' }}>
          ...
          {/* Left side middle */}
          <div className="absolute animate-float" style={{ left: '8%', top: '50%', animationDelay: '0.8s', animationDuration: '3.5s' }}>
          ...
          {/* Top right corner */}
          <div className="absolute animate-float" style={{ right: '5%', top: '12%', animationDelay: '0.4s', animationDuration: '3.2s' }}>
            <div className="w-12 h-12 bg-white/5 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/10">
          ...
          {/* Right side middle */}
          <div className="absolute animate-float" style={{ right: '7%', top: '48%', animationDelay: '1.0s', animationDuration: '3.8s' }}>
            <div className="w-10 h-10 bg-white/5 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/10">
          ...
          {/* Bottom left */}
          <div className="absolute animate-float" style={{ left: '12%', bottom: '15%', animationDelay: '1.3s', animationDuration: '3.6s' }}>
            <div className="w-10 h-10 bg-white/5 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/10">
              <Brain className="w-5 h-5 text-blue-400" />
            </div>
          </div>
          ...
          {/* Bottom right */}
          <div className="absolute animate-float" style={{ right: '10%', bottom: '18%', animationDelay: '1.6s', animationDuration: '4s' }}>
            <div className="w-10 h-10 bg-white/5 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/10">
      ...
      <section className="relative py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-16 rounded-3xl bg-gradient-to-br from-violet-600/20 to-indigo-600/20 backdrop-blur-xl border border-white/10">
            ...
            <button className="group px-10 py-5 bg-gradient-to-r from-violet-600 to-indigo-600 rounded-full font-semibold text-xl hover:shadow-2xl hover:shadow-violet-500/50 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 mx-auto">
              Get Started Now
